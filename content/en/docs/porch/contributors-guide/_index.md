...
* [locally](/docs/porch/contributors-guide/environment-setup.md)
* [on GKE](/docs/porch/running-porch/running-on-GKE.md)
...
To debug Porch, run Porch [locally](/docs/porch/contributors-guide/environment-setup.md), exit porch server running
...
* `make` or `make all`: builds and runs Porch [locally](/docs/porch/contributors-guide/environment-setup.md)
