...
with security or other patches that require updates. [Configuration as Data]({{% relref "/docs/neo-porch/1_overview/relevant_old_docs/config-as-data.md" %}}) in
general, and [Package Orchestration]({{% relref "/docs/neo-porch/2_concepts/relevant_old_docs/package-orchestration.md" %}}) in particular, can assist in this.
...
- [Package Orchestration]({{% relref "/docs/neo-porch/2_concepts/relevant_old_docs/package-orchestration.md" %}})
