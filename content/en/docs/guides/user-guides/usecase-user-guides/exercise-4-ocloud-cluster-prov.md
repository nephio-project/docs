...
- A Nephio Management cluster: 
  - See the [installation guides](/docs/guides/install-guides/_index.md#introduction) for detailed demo environment options.
- With the following *optional* operator pkgs deployed:
  - [o2ims operator](/docs/guides/install-guides/optional-components.md#o2ims-operator)
...
The exercise will attempt to simulate the [O-RAN O-Cloud](/docs/network-architecture/o-ran-integration.md#overview) 
architecture by deploying the [focom operator](/docs/guides/install-guides/optional-components.md#focom-operator)
...
Deploy the [focom operator](/docs/guides/install-guides/optional-components.md#focom-operator) to the new cluster
```bash
