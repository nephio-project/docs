...
- [ArgoCD GitOps workload reconciliation support](tbd)
...
The *Recommended* sizes above are required to execute the 
[Free5GC](content/en/docs/guides/user-guides/usecase-user-guides/exercise-1-free5gc.md) and 
[OAI RAN](content/en/docs/guides/user-guides/usecase-user-guides/exercise-2-oai.md) use cases.
...
These installations have been verified on (VMs) virtual machines running on Google Cloud.
...
**<span style="color:red">These need to be reviewed, verified and updated accordingly</span>**
...
* Feedback of the workload deployments from the workload clusters to the management cluster is limited. 
You may need to connect directly to the workload cluster via kubectl to resolve any deployment issues.
* The web UI features are limited to the viewing and editing of packages, and resources in those packages, and their deployment. 
